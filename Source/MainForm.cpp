...
void MainForm::setDailyLabels(juce::Label* lbl, std::string dailyStatus)
{
    ...
    {
        lbl->setColour(juce::Label::backgroundColourId, juce::Colours::grey);
    }
...
void MainForm::colorLabels(int numberOfHabits)
{
    ...
    if (numberOfHabits == 0)
    {
        juce__label3->setVisible(false); juce__label13->setVisible(false); juce__label22->setVisible(false);
        juce__label4->setVisible(false); juce__label14->setVisible(false); juce__label23->setVisible(false);
        juce__label5->setVisible(false); juce__label15->setVisible(false); juce__label24->setVisible(false);
        juce__label6->setVisible(false); juce__label16->setVisible(false); juce__label25->setVisible(false);
        juce__label7->setVisible(false); juce__label17->setVisible(false); juce__label26->setVisible(false);
        juce__label8->setVisible(false); juce__label18->setVisible(false); juce__label27->setVisible(false);
        juce__label9->setVisible(false); juce__label19->setVisible(false); juce__label28->setVisible(false);
        juce__label10->setVisible(false); juce__label20->setVisible(false); juce__label29->setVisible(false);
        juce__label11->setVisible(false); juce__label21->setVisible(false); juce__label30->setVisible(false);
        juce__label12->setVisible(false);

        juce__label31->setVisible(false); juce__label32->setVisible(false); juce__label33->setVisible(false);
        juce__label34->setVisible(false); juce__label35->setVisible(false); juce__label36->setVisible(false);
        juce__label37->setVisible(false); juce__label38->setVisible(false); juce__label39->setVisible(false);
        juce__label40->setVisible(false); juce__label41->setVisible(false); juce__label42->setVisible(false);
        juce__label43->setVisible(false); juce__label44->setVisible(false); juce__label45->setVisible(false);
        juce__label46->setVisible(false); juce__label47->setVisible(false); juce__label48->setVisible(false);
        juce__label49->setVisible(false); juce__label50->setVisible(false); juce__label51->setVisible(false);
        juce__label52->setVisible(false); juce__label53->setVisible(false); juce__label54->setVisible(false);
        juce__label55->setVisible(false); juce__label56->setVisible(false); juce__label57->setVisible(false);
        juce__label58->setVisible(false);

        juce__label59->setVisible(false); juce__label69->setVisible(false); juce__label78->setVisible(false);
        juce__label60->setVisible(false); juce__label70->setVisible(false); juce__label79->setVisible(false);
        juce__label61->setVisible(false); juce__label71->setVisible(false); juce__label80->setVisible(false);
        juce__label62->setVisible(false); juce__label72->setVisible(false); juce__label81->setVisible(false);
        juce__label63->setVisible(false); juce__label73->setVisible(false); juce__label82->setVisible(false);
        juce__label64->setVisible(false); juce__label74->setVisible(false); juce__label83->setVisible(false);
        juce__label65->setVisible(false); juce__label75->setVisible(false); juce__label84->setVisible(false);
        juce__label66->setVisible(false); juce__label76->setVisible(false); juce__label85->setVisible(false);
        juce__label67->setVisible(false); juce__label77->setVisible(false); juce__label86->setVisible(false);
    ...
    if (numberOfHabits == 1)
    {
        ...
        juce__label3->setVisible(true); juce__label13->setVisible(true); juce__label22->setVisible(true);
        juce__label4->setVisible(true); juce__label14->setVisible(true); juce__label23->setVisible(true);
        juce__label5->setVisible(true); juce__label15->setVisible(true); juce__label24->setVisible(true);
        juce__label6->setVisible(true); juce__label16->setVisible(true); juce__label25->setVisible(true);
        juce__label7->setVisible(true); juce__label17->setVisible(true); juce__label26->setVisible(true);
        juce__label8->setVisible(true); juce__label18->setVisible(true); juce__label27->setVisible(true);
        juce__label9->setVisible(true); juce__label19->setVisible(true); juce__label28->setVisible(true);
        juce__label10->setVisible(true); juce__label20->setVisible(true); juce__label29->setVisible(true);
        juce__label11->setVisible(true); juce__label21->setVisible(true); juce__label30->setVisible(true);
        juce__label12->setVisible(true);

        //std::string cont = statusVector[0];

        setDailyLabels(juce__label3.get(), statusVector[0]); setDailyLabels(juce__label4.get(), statusVector[1]);
        setDailyLabels(juce__label5.get(), statusVector[2]); setDailyLabels(juce__label6.get(), statusVector[3]);
        setDailyLabels(juce__label7.get(), statusVector[4]); setDailyLabels(juce__label8.get(), statusVector[5]);
        setDailyLabels(juce__label9.get(), statusVector[6]); setDailyLabels(juce__label10.get(), statusVector[7]);
        setDailyLabels(juce__label11.get(), statusVector[8]); setDailyLabels(juce__label12.get(), statusVector[9]);
        setDailyLabels(juce__label13.get(), statusVector[10]); setDailyLabels(juce__label14.get(), statusVector[11]);
        setDailyLabels(juce__label15.get(), statusVector[12]); setDailyLabels(juce__label16.get(), statusVector[13]);
        setDailyLabels(juce__label17.get(), statusVector[14]); setDailyLabels(juce__label18.get(), statusVector[15]);
        setDailyLabels(juce__label19.get(), statusVector[16]); setDailyLabels(juce__label20.get(), statusVector[17]);
        setDailyLabels(juce__label21.get(), statusVector[18]); setDailyLabels(juce__label22.get(), statusVector[19]);
        setDailyLabels(juce__label23.get(), statusVector[20]); setDailyLabels(juce__label24.get(), statusVector[21]);
        setDailyLabels(juce__label25.get(), statusVector[22]); setDailyLabels(juce__label26.get(), statusVector[23]);
        setDailyLabels(juce__label27.get(), statusVector[24]); setDailyLabels(juce__label28.get(), statusVector[25]);
        setDailyLabels(juce__label29.get(), statusVector[26]); setDailyLabels(juce__label30.get(), statusVector[27]);
    ...
    if (numberOfHabits == 2)
    {
        ...
        juce__label31->setVisible(true); juce__label32->setVisible(true); juce__label33->setVisible(true);
        juce__label34->setVisible(true); juce__label35->setVisible(true); juce__label36->setVisible(true);
        juce__label37->setVisible(true); juce__label38->setVisible(true); juce__label39->setVisible(true);
        juce__label40->setVisible(true); juce__label41->setVisible(true); juce__label42->setVisible(true);
        juce__label43->setVisible(true); juce__label44->setVisible(true); juce__label45->setVisible(true);
        juce__label46->setVisible(true); juce__label47->setVisible(true); juce__label48->setVisible(true);
        juce__label49->setVisible(true); juce__label50->setVisible(true); juce__label51->setVisible(true);
        juce__label52->setVisible(true); juce__label53->setVisible(true); juce__label54->setVisible(true);
        juce__label55->setVisible(true); juce__label56->setVisible(true); juce__label57->setVisible(true);
    ...
    if (numberOfHabits == 3)
    {
        ...
        juce__label59->setVisible(true); juce__label69->setVisible(true); juce__label78->setVisible(true);
        juce__label60->setVisible(true); juce__label70->setVisible(true); juce__label79->setVisible(true);
        juce__label61->setVisible(true); juce__label71->setVisible(true); juce__label80->setVisible(true);
        juce__label62->setVisible(true); juce__label72->setVisible(true); juce__label81->setVisible(true);
        juce__label63->setVisible(true); juce__label73->setVisible(true); juce__label82->setVisible(true);
        juce__label64->setVisible(true); juce__label74->setVisible(true); juce__label83->setVisible(true);
        juce__label65->setVisible(true); juce__label75->setVisible(true); juce__label84->setVisible(true);
        juce__label66->setVisible(true); juce__label76->setVisible(true); juce__label85->setVisible(true);
        juce__label67->setVisible(true); juce__label77->setVisible(true); juce__label86->setVisible(true);
